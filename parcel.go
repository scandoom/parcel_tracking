...
func (s ParcelStore) Get(number int) (Parcel, error) {
	row := s.db.QueryRow("SELECT client, status, address, created_at FROM parcel WHERE number = :number", sql.Named("number", number)) // реализуйте чтение строки по заданному number
